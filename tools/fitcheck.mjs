...
for (const vp of VIEWPORTS) {
  ...
  await page.click('[data-tab="calendar"]'); await page.waitForTimeout(300);
  await page.click('#calSeg button[data-cseg="habits"]'); await page.waitForTimeout(600); await measureDoc("calendar/습관");
  await page.click('#calSeg button[data-cseg="calendar"]'); await page.waitForTimeout(200);
