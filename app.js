...
const DX_THEMES = {
  ...
  anger:   { label: "분노·짜증이 올라와요", dx: "화가 자주 치밀어요. 충동과 결정 사이에 ‘틈’을 만드는 게 도움이 돼요.", rx: ["breath", "plan", "boundary"] },
  sadness: { label: "마음이 가라앉아 있어요", dx: "저조·우울감이 두드러져요. 작은 활동과 연결이 회복을 도와요.", rx: ["ba", "connect", "selfcomp"] },
  lonely:  { label: "외로움이 자주 느껴져요", dx: "혼자라는 느낌이 커요. 아주 가는 연결 하나가 큰 완충이 돼요.", rx: ["connect", "ba", "selfcomp"] },
  burnout: { label: "소진·낮은 활력", dx: "에너지가 고갈된 소진 신호예요. 회복과 수면을 가장 앞에 둬요.", rx: ["rest", "sleep", "ba"] },
  foggy:   { label: "생각이 뒤엉켜 있어요", dx: "머리가 멍하고 복잡해요. 꺼내 적어 정리하면 한결 또렷해져요.", rx: ["labeling", "plan", "rest"] },
